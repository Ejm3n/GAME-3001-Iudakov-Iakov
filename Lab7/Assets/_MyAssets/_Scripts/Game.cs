...
public class Game : MonoBehaviour
{
    ...
    private void Initialize()
    {
        ...
        SOMA.AddSound("Mutara", Resources.Load<AudioClip>("Sounds/Mutara"), SoundManager.SoundType.SOUND_MUSIC);
        SOMA.AddSound("Klingon", Resources.Load<AudioClip>("Sounds/Klingon"), SoundManager.SoundType.SOUND_MUSIC);
